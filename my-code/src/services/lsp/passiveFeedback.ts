...
/**
 * Map LSP severity to my-code diagnostic severity
 *
 * Maps LSP severity numbers to my-code diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to my-code diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by my-code's attachment system.
 */
 ...
 * from all LSP servers and routes them to my-code's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to my-code format (can throw on invalid URIs)
