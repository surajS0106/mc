 ...
 * Initialized during my-code startup.
 */
 ...
 * asynchronously during my-code startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during my-code startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/ollamas/my-code/issues/15521:
 ...
 *
 * This should be called during my-code shutdown. Stops all running LSP servers
